...
function HeroDescription() {
  ...
  return (
    <div id="description" className="w-full bg-purple-950">
      <div className="container flex flex-col items-start max-w-[1024px] h-auto overflow-y-auto px-8 py-16 text-center mx-auto">
        <motion.h1
          ref={ref}
          variants={variants}
          initial="hidden"
